...
0000000000001050 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>:
    1050:	f3 0f 1e fa          	endbr64
    1054:	ff 25 76 2f 00 00    	jmp    *0x2f76(%rip)        # 3fd0 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@GLIBCXX_3.4>
...
0000000000001149 <main>:
    ...
    115b:	48 8d 05 de 2e 00 00 	lea    0x2ede(%rip),%rax        # 4040 <std::cout@GLIBCXX_3.4>
    1162:	48 89 c7             	mov    %rax,%rdi
    1165:	e8 e6 fe ff ff       	call   1050 <std::basic_ostream<char, std::char_traits<char> >& std::operator<< <std::char_traits<char> >(std::basic_ostream<char, std::char_traits<char> >&, char const*)@plt>
